...
class ShiftLcd {
  public:
    ...
    void write(const char msg[]); // Write a character array
    void write(const char msg1[], const char msg2[]); // Write two character arrays
    void write(const char msg[], int n); // Write a character array and an integer
  ...
  private:
    ...
    const uint8_t ALL_BLACK = 0b11111111;
